...
class TestGetPosition:
    ...
    def test_get_position_index_too_high(self):
    ...
    def test_get_position_missing_id_column(self):
    ...
    def test_get_position_duplicate_ids_returns_first(self):
...
class TestReadMethod:
    ...
    def test_read_file_by_id_returns_string(self):
    ...
    def test_read_folder_calls_read_meta(self, monkeypatch):
        ...
        def mock_read_meta(row):
            ...
            return TacoDataFrameArrow(mock_table, "folder")
        ...
        # Should return TacoDataFrame
        assert isinstance(result, TacoDataFrameArrow)